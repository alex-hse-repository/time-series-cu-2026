...
| 3 | Экспоненциальное сглаживание (ETS) и сезонность | [`week_3`](week_3/README.md) |
| 4 | Стационарность, ARIMA и идентификация порядков | [`week_4`](week_4/README.md) |
| 5 | SARIMA и регрессоры | [`week_5`](week_5/README.md) |
