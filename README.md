...
## Оценка активности на семинарах

Активность на семинарах оценивается через квизы по материалам лекций (обычно в начале второго семинара).

**Система оценивания:**
- За каждый правильный ответ: **5 баллов** + бонусы за скорость
- Итоговая оценка (из 10):

$$\text{Score} = \min\left(\text{round}\left(\frac{\text{Сумма баллов}}{5 \times \text{Кол-во вопросов}} \times 10\right), 10\right)$$

Где:
- **Сумма баллов** — сумма всех баллов за правильные ответы и бонусы
- **5 × Кол-во вопросов** — максимальное возможное базовое количество баллов в квизе
